...
namespace MyFirstMAUIApp.ViewViewModels.CollectionsUpdatable
{
    public class UpdateableCollectionViewModel : BaseViewModel
    {
        ...
        public UpdateableCollectionViewModel()
        {
            ...
            Title = TitleCollections.ButtonTextCollectionsIn;
...
#pragma warning disable CA1416 // Validate platform compatibility
        ...
        public ICommand AddCommand => new Command(async () =>
        {
            ...
            await Application.Current.MainPage.Navigation.PushAsync(new AddCollectionPage());
        ...
        public ICommand UpdateCommand => new Command<MarvelMovies>(async movie =>
        {
            ...
            await Application.Current.MainPage.Navigation.PushAsync(new EditCollectionPage(movie));
